...
function Licao8({ slug, handleNext }) {
    ...
    useEffect(() => {
        licao.map(atividade => (setVerifica(atividade.licao.atividade8.res_correta)));
    }, [licao]);
                ...
                return (
                    <div key={atividade.id_atividade}>
                        ...
                        <div className={styles.Txt}>
                            <Center>
                                <Text>{atividade.licao.atividade8.texto}</Text>
                            </Center>
                        </div>
                        <div className={styles.Op}>
                            {atividade.licao.atividade8.res_escrita == 0 ?
                                <>
                                    <Center>
                                        <RadioGroup className={styles.RadioGroup}>
                                            <Stack direction="row">
                                                ...
                                                {/* </Box> */}
                                                <Radio value="1" onChange={(e) => setRes(atividade.licao.atividade8.options[licaoOp[0]])} className={styles.Input1}>{atividade.licao.atividade8.options[licaoOp[0]]}</Radio>
                                                <Radio value="2" onChange={(e) => setRes(atividade.licao.atividade8.options[licaoOp[1]])}>{atividade.licao.atividade8.options[licaoOp[1]]}</Radio>
                                                <Radio value="3" onChange={(e) => setRes(atividade.licao.atividade8.options[licaoOp[2]])}>{atividade.licao.atividade8.options[licaoOp[2]]}</Radio>
                                                <Radio value="4" onChange={(e) => setRes(atividade.licao.atividade8.options[licaoOp[3]])}>{atividade.licao.atividade8.options[licaoOp[3]]}</Radio>
                                            </Stack>
                                        </RadioGroup>
                                    </Center>
                                </>
