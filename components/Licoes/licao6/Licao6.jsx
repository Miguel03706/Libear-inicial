...
function Licao6({ slug, handleNext }) {
    ...
    useEffect(() => {
        licao.map(atividade => (setVerifica(atividade.licao.atividade6.res_correta)));
    }, [licao]);
                ...
                return (
                    <div key={atividade.id_atividade}>
                        <div className={styles.Img}>
                            <Center>
                                <Image src={`../../images/atividades/${atividade.licao.atividade6.imagem}`}  h="300px" w="auto" p="10px" />
                            </Center>
                        </div>
                        <div className={styles.Txt}>
                            <Center>
                                <Text>{atividade.licao.atividade6.texto}</Text>
                            </Center>
                        </div>
                        <div className={styles.Op}>
                            {atividade.licao.atividade6.res_escrita == 0 ?
                                <>
                                    <Center>
                                        <RadioGroup className={styles.RadioGroup}>
                                            <Stack direction="row">
                                                ...
                                                {/* </Box> */}
                                                <Radio value="1" onChange={(e) => setRes(atividade.licao.atividade6.options[licaoOp[0]])} className={styles.Input1}>{atividade.licao.atividade6.options[licaoOp[0]]}</Radio>
                                                <Radio value="2" onChange={(e) => setRes(atividade.licao.atividade6.options[licaoOp[1]])}>{atividade.licao.atividade6.options[licaoOp[1]]}</Radio>
                                                <Radio value="3" onChange={(e) => setRes(atividade.licao.atividade6.options[licaoOp[2]])}>{atividade.licao.atividade6.options[licaoOp[2]]}</Radio>
                                                <Radio value="4" onChange={(e) => setRes(atividade.licao.atividade6.options[licaoOp[3]])}>{atividade.licao.atividade6.options[licaoOp[3]]}</Radio>
                                            </Stack>
                                        </RadioGroup>
                                    </Center>
                                </>
